    ...
    <tbody>
        ...
        if ($katakunci != '') {
            ...
            for ($x = 0; $x < count($array_katakunci); $x++) {
                $sqlcari[] = "(nama like '%" . $array_katakunci[$x] . "%' or product like '%" . $array_katakunci[$x] . "%' or jenis like '%" . $array_katakunci[$x]."%' or stok like '%" . $array_katakunci[$x] . "%')". "%' or keterangan like '%" . $array_katakunci[$x] . "%')";
            }
        ...
        ?>
            <tr>
                ...
                <td>
                    ...
                    <a href="halaman.php?op=delete&id=<?php echo $r1['id'] ?>" onclick="return confirm('Apakah anda yakin akan menghapus data?')">
